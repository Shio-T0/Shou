...
class PlaybackService : Service() {
    ...
    private fun render(p: Playback) {
        ...
        val notif = buildNotification(p, state)
    ...
    private fun buildNotification(p: Playback, state: Int): Notification {
        ...
        return NotificationCompat.Builder(this, Notifications.CHANNEL_PLAYBACK)
            ...
            .setContentText(p.subtitle.ifBlank { ShouStore.activeName(applicationContext) })
